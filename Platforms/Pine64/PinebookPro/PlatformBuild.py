...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        """
        return "Pine64/PinebookPro/PinebookPro.dsc", {}
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("ACTIVE_PLATFORM", "Platforms/Pine64/PinebookPro/PinebookPro.dsc", "Platform Hardcoded")
        ...
        self.env.SetValue("CONF_AUTOGEN_INCLUDE_PATH",
                          self.mws.join(self.ws, "Platforms", "Pine64", "PinebookPro", "Include"), "Platform Defined")

        self.env.SetValue("YAML_POLICY_FILE", self.mws.join(self.ws, "PinebookPro", "PolicyData", "PolicyDataUsb.yaml"),
                          "Platform Hardcoded")
        self.env.SetValue("POLICY_DATA_STRUCT_FOLDER", self.mws.join(self.ws, "PinebookPro", "Include"), "Platform Defined")
        self.env.SetValue('POLICY_REPORT_FOLDER', self.mws.join(self.ws, "PinebookPro", "PolicyData"), "Platform Defined")
        self.env.SetValue('MU_SCHEMA_DIR', self.mws.join(self.ws, "Platforms", "Pine64", "PinebookPro", "CfgData"),
                          "Platform Defined")
        self.env.SetValue('MU_SCHEMA_FILE_NAME', "PinebookProCfgData.xml", "Platform Hardcoded")
        self.env.SetValue('CONF_PROFILE_PATHS',
                          self.mws.join(self.ws, 'Platforms', 'Pine64', 'PinebookPro', 'CfgData',
                                        'Profile0PinebookProCfgData.csv') + " " +
                          self.mws.join(self.ws, 'Platforms', 'Pine64', 'PinebookPro', 'CfgData',
                                        'Profile1PinebookProCfgData.csv'),
                          "Platform Hardcoded"
                          )
