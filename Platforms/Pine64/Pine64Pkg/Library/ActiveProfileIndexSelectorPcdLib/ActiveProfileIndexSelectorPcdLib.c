/** @file ActiveProfileIndexSelectorPcdLib.c
  PCD instance of ActiveProfileIndexSelectorLib. It is expected that the PINE64/Platform
  will override this library to query the current boot active profile index from the
  proper source of truth.

  This library reads gPine64PkgTokenSpaceGuid.PcdActiveProfileIndex and returns the active
  profile index.
