  ...
  )
{
  ...
  *Length = VerifyStringLength (
              ...
              Ver.Pine64Ver.GenerationBCD,
              (Ver.Pine64Ver.YearBCD | VERSION_YY_OFFSET),
              Ver.Pine64Ver.WorkweekBCD,
              Ver.Pine64Ver.RevisionBCD
              );
  if (*Length != VERSION_STR_LENGTH) {
    DEBUG ((
      DEBUG_ERROR,
...
{
  EFI_STATUS          Status;
  PINE64_BUILD_DATE_VER  BuildDate;
  ...
  *Length = VerifyStringLength (
              DATE_STR_LENGTH,
              DATE_STR_TEMPLATE,
              BuildDate.Pine64Date.MonthBCD,
              BuildDate.Pine64Date.DayBCD,
              (BuildDate.Pine64Date.YearBCD | VERSION_YY_OFFSET)
              );
  if (*Length != DATE_STR_LENGTH) {
    DEBUG ((
      DEBUG_ERROR,
