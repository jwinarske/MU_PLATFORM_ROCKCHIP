...
STATIC CONST EFI_GUID mRk3399AcpiTableFile = { 0x7E374E25, 0x8E01, 0x4FEE, {0x87, 0xF2, 0x39, 0x0C, 0x23, 0xC6, 0x06, 0xCD} };
  ...
  )
{
  ...
  if (EFI_ERROR (Status)) {
    DEBUG ((EFI_D_ERROR, "Rk3399Dxe: Failed to install ShellDynCmdRunAxf\n"));
  }
