...
/**
  Read an 8-bit 16550 register.  The parameter Offset is added to the base address of
  the 16550 registers that is specified by PcdSerialRegisterBase
...
{
  return FixedPcdGet64 (PcdSerialRegisterBase);
}
...
/** Rockchip UART Library Constructor
